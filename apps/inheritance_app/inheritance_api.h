...
/**
 * @file    inheritance_api.h
 * @author  Cypherock X1 Team
 * @brief   Header file to export some helper functions for the INHERITANCE app
 * @copyright Copyright (c) 2023 HODL TECH PTE LTD
 * <br/> You may obtain a copy of license at <a href="https://mitcc.org/"
 * target=_blank>https://mitcc.org/</a>
 */
#ifndef INHERITANCE_API_H
#define INHERITANCE_API_H
...
/**
 * @brief API to decode query from host with `INHERITANCE_QUERY_FIELDS`
 *
 * @param[in] data: PB encoded bytestream received from host
 * @param[in] data_size: size of pb encoded bytestream
 * @param[out] query_out: @ref inheritance_query_t obj to copy the decoded
 * result to
...
/**
 * @brief Encodes the INHERITANCE result with `INHERITANCE_RESULT_FIELDS` to
 * byte-stream
 *
 * @param[in] result: object of populated @ref inheritance_result_t to be
 * encoded
 ...
 * `inheritance_query_t` matches against the expected tag.
 *
 * @param query The query of type `inheritance_query_t` to be checked
 ...
 * inheritance_result_t result_tag set in result.which_response field
 *
 * @param result_tag Result tag to be set in the inheritance_result_t result
 * @return inheritance_result_t Result object of type inheritance_result_t
 */
...
/**
 * @brief This API encodes inheritance_result_t in protobuf structure.
 * @details If the encoding is successful, then it sends the corresponding
 * result to the host.
 *
 * The function ASSERTs the result of encode_inheritance_result internally.
 *
...
/**
 * @brief This API receives request of type inheritance_query_t of type
 ...
 * the tag
 */
bool inheritance_get_query(inheritance_query_t *query, pb_size_t exp_query_tag);
