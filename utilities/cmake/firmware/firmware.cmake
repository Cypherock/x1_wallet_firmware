...
add_executable(${EXECUTABLE} ${SOURCES} vendor/cypherock-bignum/bignum_internal.c vendor/cypherock-bignum/mini-gmp.c vendor/cypherock-bignum/mini-gmp-helpers.c vendor/tinybn/bn.c ${CMAKE_CURRENT_BINARY_DIR}/version.c ${PROTO_SRCS} ${PROTO_HDRS} ${INCLUDES} ${LINKER_SCRIPT} ${STARTUP_FILE})
