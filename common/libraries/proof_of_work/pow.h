 ...
 * @file
 * 
 * @brief Contains proof of work task and related function. The nonce, target and random number
 * are fetched from flash and are 32 byte array in big endian form.
 * 
 * @note 2^240 will be represented as 
 * uint8_t arr[32] = {0x00,0x00,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
 * 
 * @details
 ...
 * 
 * The nonce is provided to the card which verifies condition (1). If the condition
 * is satisfied it gets unlocked and corresponding status word is returned.
 * 
 * The approx time left and current nonce is stored in flash and updated periodically.
 */
