...
/**
 * @brief Pops the last inserted element from the queue and returns it if it exists and returns NULL otherwise
 * 
 * @return ekp_queue_node* 
 */
...
/**
 * @brief Queue processing function which pops the queue and and updates the indev data
 *        to be used by the lvgl
 * 
