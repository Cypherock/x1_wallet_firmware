...
/**
 * @brief Creates a slideshow of instruction screen with manual left and right control arrows
 * @details
 * 
 ...
 *                content on screen can be text and/or image, position needs to be
 *                defined in the content object for that screen.
 *                Both image and text can be passed together, alignments and
 *                overlaps need to be verified manually.
