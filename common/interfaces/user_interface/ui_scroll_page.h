...
/**
 * @brief This API renders a scrollable UI page, which displays UI in the following
 * format:
 * |***************Floating heading***************|
 * |************** Scrollable text 1**************|
 * |<************* Scrollable text 2*************>|
 ...
 * 
 * @param p_page_ui_heading Pointer to the heading of the screen which is shown as floating text
 * @param p_page_ui_body Pointer to the body of the screen which is scrollable. 
 * It should end with Null (\0) character.
 * @param page_orientation Value of type e_scrollable_page_orientation_t which selects whether scrolling is
 * to be done horizontally or vertically. In reality, scrolling happens vertically but visibility left/right arrow
 * buttons is manipulated 
 * @param bool_cancel_accept_btn_visible If true, then accept and cancel button is visible in every page
 * If false, then accept and cancel button is only visible at the last page
 */
