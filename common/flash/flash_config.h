...
#define PERM_DATA_MAX_PAGES (1)     ///< Maximum number of pages for the permanent data area under firewall
...
#define XPUB_SIZE 112               ///< Size of extended public key. Refer BIP32 doc https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki
#define FAMILY_ID_SIZE 4            ///< Size of family id of Card
#define MAX_TRANSACTION_SIZE 200    ///< Maximum size of transaction for bunker signature (offline signing)
#define IO_KEY_SIZE 32              ///< Size of IO protection key (used for encrypted comm b/w MCU and ATECC608A)
...
#define FS_KEYSTORE_PRIVKEY_LEN 32  ///< Length of private key in keystore entry
...
typedef enum ret_code {
    ...
    INCONSISTENT_STATE  ///< Not an error by client but some inconsistency in flash -
                        ///< most likely due to some bug by me
