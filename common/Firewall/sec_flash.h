 ...
 * @details
 * To initiate firmware update, boot state needs to be updated to UPGRADE_INITIATED,
 * Upon reset bootloader will detect the UPGRADE_INITIATED state and wait for desktop
 * app to start the DFU package transmission. The function also sets RTC backup register 0
 * to value 2 to indicate boot state was changed by firmware and not by fault.
 *
 * @since v1.0.0
 */
 ...
 * @details The set of keys stored in the firewall region with one-time write. So the keys
 * cannot be overwritten by the application.
 *
 * @since v1.0.0
 */
#pragma pack(push, 1)
 ...
 * @details This is a one-time write data hence it cannot be changed once written.
 *
 * @since v1.0.0
 */
#pragma pack(push, 1)
