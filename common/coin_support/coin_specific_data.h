...
#define FLASH_COIN_SPECIFIC_BASE_ADDRESS (1 + FLASH_END - FLASH_PAGE_SIZE * FLASH_COIN_SPECIFIC_PAGE_COUNT)
 ...
 * 
 * @param array 								resultant array to be filled.
...
/**
 * @brief finds the coin specific data by coin_specific_data_struct in the flash.
 * 
 * @param coin_specific_data		coin specific data struct to be found and filled.
 ...
 * @param coin_data_size 				size of the coin data in the given struct.
 */
