...
void uc1610_init(void) {
  ...
  cmd_buf[9] =
      UC1610_SET_AC | UC1610_AC_WA_FLAG; /* set auto increment wrap around */
  cmd_buf[10] = UC1610_SET_INVERSE_DISPLAY |
                1; /* invert colors to complies lv color system */
...
void uc1610_flush_cb(lv_disp_drv_t *disp_drv,
  ...
  uint8_t act_x2 =
      area->x2 > UC1610_HOR_RES - 1 ? UC1610_HOR_RES - 1 : area->x2;
  uint8_t act_y2 =
      area->y2 > UC1610_VER_RES - 1 ? UC1610_VER_RES - 1 : area->y2;
  ...
  cmd_buf[0] =
      UC1610_SET_WINDOW_PROGRAM_ENABLE | 0; /* before changing boundaries */
  ...
  cmd_buf[8] = act_y2 >> 2;
  cmd_buf[9] =
      UC1610_SET_WINDOW_PROGRAM_ENABLE | 1; /* entering window programming */
