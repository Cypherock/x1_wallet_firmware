...
uint8_t BSP_LPUART1_UART_Write(uint8_t* data, uint16_t size) { return 1; }
uint8_t BSP_LPUART1_UART_Read(uint8_t* data, uint16_t size) { return 1; }
uint8_t BSP_LPUART1_UART_ClearReadBuff() { return 1; }
