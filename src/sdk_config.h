...
#define BSP_USB_PID \
  0x0102  ///PID Wallet X1[8:15]:0x01, HARDWARE version Major[4:7]:0x0, Initial[0:3]:0x2
#elif (X1WALLET_MAIN == 1)
#define BSP_USB_PID \
  0x0103  ///PID Wallet X1[8:15]:0x01, HARDWARE version Major[4:7]:0x0, Main[0:3]:0x3
#endif
