...
#pragma once
  ...
  *
  */
enum LEVEL_ONE_TASKS
{ 
    LEVEL_ONE_MAIN_SCREEN
};

/**
 * @brief tasks at level two
 * These tasks are entered by flow_level.level_one only if (counter.level > LEVEL_ONE)
 */
enum LEVEL_TWO
{
...
/**
 * @brief enum LEVEL_THREE_OLD_WALLET_TASKS offers total of 2 menu options.
 * It means that some tasks are entered based on inputs from CySync or invoked internally
 */
enum LEVEL_THREE_OLD_WALLET_TASKS
{
    /* First 2 tasks are entered based on user inputs */
    LEVEL_THREE_VIEW_SEED = 1,
    LEVEL_THREE_DELETE_WALLET,
    /* Below states are not entered based on user actions */
...
/**
 * @brief: enum LEVEL_THREE_ADVANCED_SETTINGS_TASKS offers total of 
 * NUMBER_OF_OPTIONS_ADVANCED_OPTIONS menu options.
 * It means that some tasks are not entered based on user inputs but are internally handled
 */
enum LEVEL_THREE_ADVANCED_SETTINGS_TASKS
{
    /* First NUMBER_OF_OPTIONS_ADVANCED_OPTIONS tasks are entered based on user inputs */
