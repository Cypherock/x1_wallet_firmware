...
enum PGP_KEY_MANAGEMENT {
  LEVEL_THREE_PGP_INIT = 1,
  LEVEL_THREE_PGP_CHOOSE_WALLET,
  LEVEL_THREE_PGP_ENTER_PASSPHRASE,
  LEVEL_THREE_PGP_CONFIRM_PASSPHRASE,
  LEVEL_THREE_PGP_CHECK_PIN,
  LEVEL_THREE_PGP_ENTER_PIN,
  LEVEL_THREE_PGP_TAP_CARD,
  LEVEL_THREE_PGP_DERIVE_HDNODE,
  LEVEL_THREE_PGP_IDENTIFY_REQUEST,
  LEVEL_THREE_PGP_PUBKEY,
  LEVEL_THREE_PGP_ECDH,
  LEVEL_THREE_PGP_SIGN,
  LEVEL_THREE_PGP_FINISH,
};
