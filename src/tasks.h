 ...
 *        FOR NEW WALLET
 */
enum LEVEL_THREE_NEW_WALLET_TASKS { LEVEL_THREE_GENERATE_WALLET = 1, LEVEL_THREE_RESTORE_WALLET };
 ...
 *
 */
enum EXPORT_WALLET_TASKS { EXPORT_WALLET_SELECT_WALLET = 1, EXPORT_WALLET_FINAL_SCREEN };
...
enum SIGN_MESSAGE_ETH {
  ...
  SIGN_MSG_RAW_MSG_RECEIVED_ETH,
  SIGN_MSG_VERIFY_CONTRACT_ADDRESS_ETH,
 ...
 *
 */
enum RESTORE_WALLET_ENTER_MNEMONICS_TASKS { RESTORE_WALLET_ENTER_MNEMONIC = 1, RESTORE_WALLET_MNEMONIC_SUGGESTION };
...
#ifdef DEV_BUILD
enum CARD_UPGRADE_TASKS { CARD_UPGRADE_TAP_CARD_MESSAGE = 1, CARD_UPGRADE_SELECT_CARD, CARD_UPGRADE_FORWARD_MESSAGE };
#endif
...
enum CARD_HC_TASKS { CARD_HC_START = 1, CARD_HC_TAP_CARD, CARD_HC_DISPLAY_CARD_HEALTH, CARD_HC_DISPLAY_WALLETS };
#endif