 ...
 *
 */
enum SWAP_TRANSACTION_TASKS {
    SWAP_CONFIRM_SEND_COIN = 1,
    SWAP_CONFIRM_RECEIVE_COIN,
    SWAP_SELECT_RECEIVE_WALLET_ID,
    SWAP_CONFIRM_SEND_AMOUNT,
    SWAP_CONFIRM_RECEIVE_AMOUNT,
    SWAP_CONFIRM_NETWORK_FEES,
    SWAP_VERIFY_SESSION,
    SWAP_RECV_ADDR_DERIVATION,
    SWAP_SIGN_RECEIVE_ADDRESS,
    SWAP_VERIFY_SIGNATURE,
    SWAP_SELECT_SEND_WALLET_ID,
    SWAP_TXN_UNSIGNED_TXN_WAIT_SCREEN
};
