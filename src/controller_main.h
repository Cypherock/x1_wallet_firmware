...
/**
 * @brief This function supports conversion of UI events generated by the UI
 * event handler to the current firmware architecture. Once all application
 * flows are converted by using the event getters, this function will not be
 * required.
 * TODO: Update after refactor
 * This API will be deprecated after refactor is complete
 */
