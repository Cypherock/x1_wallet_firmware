 ...
 * @details This function creates mnemonics, takes user inputs for wallet
 * configuration, writes the wallet shares on the X1 vault flash and X1 cards
 * and verifies each share
 *
